        ...
        {context => (
          <div >
            <div className="form-style-9" >
              <ul>
                <li>
                  <select className="field-style field-split align-left" placeholder="Category" name="category" id="category" onChange={this.handleChange}>
                    {context.categories.map((elt) =>
                      <option value={elt.category} key={elt.category} > {elt.category} </option>
                    )}
                  </select>
                  <select className="field-style field-split align-right" name="country" id="country" placeholder="Countries" onChange={this.handleChange} onClick={this.handleClick}>
                ...
                <li>
                  <input type="text" className="field-style field-full align-none" placeholder="Backers" name="backers" id="backers" onChange={this.handleChange} onClick={this.handleClick} value={this.state.backers} />
                </li>
                <li>
